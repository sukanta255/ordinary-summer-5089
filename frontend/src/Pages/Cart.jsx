...
import { Box, Button, Flex, Text, Heading, Spacer, Image, Accordion, AccordionItem, AccordionButton, AccordionIcon, AccordionPanel, Input } from "@chakra-ui/react";
          ...
          <Box w={["95%", "95%", "80%"]} m="auto">
            ...
            <Box border="1px solid #c8dec8" mt={8} color="green" bgColor="#E6F2E6">
              <Text alignItems="center" display="flex" gap="10px" py={2} ml={4}>
                <CheckCircleIcon />
                You have qualified for: {""}Select a gift for you or someone you love when you spend $12 or{""} more Don't forget to make your selection below
              </Text>
            </Box>
...
"" */}
                ...
                <Box mt="8">
                  <Input mt={4} w={["100%", "50%", "40%"]} borderRadius="none" m={"auto"} placeholder="Got a Coupon Code? Enter it here: " focusBorderColor="#f1f1f1" />
                  <Button mt={["2", "-1", "-1"]} w={["100%", "auto", "auto"]} borderRadius={"none"} fontFamily={"sans-serif"} fontWeight="normal">
                    ADD
                  </Button>
                </Box>
              ...
              <Accordion allowToggle w={["100%", "100%", "100%", "100%", "40%"]} mt={8} defaultIndex={[0]}>
                  ...
                  <AccordionPanel pb={4}>
                    <Box bgColor={"white"}>
                      <Flex py={4} alignItems="center" pr={4} pl={2} gap="2">
                        <Image height="70px" width={"70px"} src="https://s1.thcdn.com//productimg/70/70/13227262-1734932752281617.jpg" alt="product" />
                        <Text textAlign={"left"}>SkinMedica LYTERA 2.0 Pigment Correcting Serum</Text>
                        <InfoIcon />
                      </Flex>
                    </Box>
                    ...
                    <Box bgColor={"white"} mt="4">
                      <Flex py={4} alignItems="center" pr={4} pl={2} gap="2">
                        <Image height="70px" width={"70px"} src="https://static.thcdn.com/images/large/webp//productimg/1600/1600/11975850-1514742470154982.jpg" alt="product" />
                        <Text textAlign={"left"}>NUDESTIX Nudies All Over Face Color Matte </Text>
                        <InfoIcon />
                      </Flex>
                    </Box>
                    ...
                    <Box bgColor={"white"} mt="4">
                      <Flex py={4} alignItems="center" pr={4} pl={2} gap="2">
                        <Image height="70px" width={"70px"} src="https://static.thcdn.com/images/large/webp//productimg/1600/1600/13971588-5624998481683801.jpg" alt="product" />
                        <Text textAlign={"left"}>Deck Of Scarlet Metal Leaf Shadow Pot</Text>
                        <InfoIcon />
                      </Flex>
                    </Box>
                    ...
                    <Box bgColor={"white"} mt="4">
                      <Flex py={4} alignItems="center" pr={4} pl={2} gap="2">
                        <Image height="70px" width={"70px"} src="https://static.thcdn.com/images/large/webp//productimg/1600/1600/12590182-1754866388387935.jpg" alt="product" />
                        <Text textAlign={"left"}>Osmosis Beauty Wellness Skin Perfection Elixir </Text>
                        <InfoIcon />
                      </Flex>
                    </Box>
                  </AccordionPanel>
